...
class Connect4:
    def __init__(self, width=5, height=4):
        ...
        self.heuristic_score = None  # Dodanie pola przechowującego ocenę heurystyczną
    ...
    def draw(self):
        ...
        if self.heuristic_score is not None:  # Wyświetlanie oceny heurystycznej
            print('Heuristic score:', self.heuristic_score)

    def set_heuristic_score(self, score):  # Metoda do ustawiania oceny heurystycznej
